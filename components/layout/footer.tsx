        ...
        <footer className={styles.footer}>
            <div className={styles.left}>
                ...
                <ul className={styles.list}>
                    ...
                    <Link href='/'><li className={styles.list_item}>stories</li></Link>
                    <Link href='/'><li className={styles.list_item}>features</li></Link>
                    <Link href='/'><li className={styles.list_item}>pricing</li></Link>
                </ul>
            </div>
            <div className={styles.right}>
                <div className={styles.invite_link}>
                    <p className={styles.invite}>get an invite</p>
                    <div className={styles.image_container}><Image src={arrow} alt='arrow' className={styles.arrow}/></div>
                </div>
